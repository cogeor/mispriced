...
export function renderValuationMap(data, elementId, colorBy, metricKey) {
    ...
    // Click event
    el.removeAllListeners?.('plotly_click'); // Remove if generic Element doesn't have it, but Plotly adds it
...
//# sourceMappingURL=valuationMap.js.map