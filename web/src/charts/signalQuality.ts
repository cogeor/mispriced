...
export function buildICHeatmap(summaryData: BacktestItem[], elementId: string, filterMetric: string) {
...
export function renderSignalDecay(horizonData: any[], elementId: string) {
    const el = document.getElementById(elementId);
    if (!el) return;
