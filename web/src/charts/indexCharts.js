...
import { IndexChartItem, IndexTimeSeriesPoint } from '../types';
export function renderIndexChart(data, elementId, metricKey) {
...
export function renderIndexTimeSeries(data, elementId, metricKey) {
    const el = document.getElementById(elementId);
    if (!el)
        return;
...
//# sourceMappingURL=indexCharts.js.map